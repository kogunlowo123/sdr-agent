...
app = FastAPI(
    title="SDR Agent",
    description="Sales Development Representative AI agent that qualifies inbound leads, books meetings, handles objections, follows up with prospects, and maintains CRM hygiene for the sales development pipeline.",
    version="1.0.0",
    docs_url="/docs",
    redoc_url="/redoc",
    lifespan=lifespan,
